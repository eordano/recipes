    ...
    lib.mkMerge [
      {
        ...
        services =
          (lib.mkAliasDefinitions options.home.services)
          // lib.optionalAttrs hm.enableLorri {
            lorri.enable = true;
          };
      }
    ...
    home = {
      ...
      env =
        mkOpt' lib.types.attrs { }
          "Environment variables to set on shells (aliased to home.sessionVariables).";
    };
