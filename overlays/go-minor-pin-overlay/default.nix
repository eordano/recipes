...
#
# The trap: nixpkgs bumps the default Go (say 1.26 -> 1.27) for the whole
...
# (buildGo125Module, buildGo126Module, buildGo127Module, ...; the default
# `buildGoModule` is currently an alias for buildGo126Module). A Go package
...
#
#     let pins = { gvisor = "buildGo125Module"; foo = "buildGo126Module"; };
#     in final: prev:
#       builtins.mapAttrs
